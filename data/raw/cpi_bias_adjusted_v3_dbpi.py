...
print("\nLoading DBPI...")
dbpi = load_dbpi("dbpis-for-17-broad-categories.xlsx")
if dbpi is not None:
...
df[out_cols].round(4).to_csv("cpi_adjusted_v3_dbpi_1979_2022.csv", index=False)
print("\nCSV saved: cpi_adjusted_v3_dbpi_1979_2022.csv")
...
fig1.write_image("cpi_headline_v3.png")
with open("cpi_headline_v3.png.meta.json","w") as f:
    json.dump({"caption": "US CPI: Official vs Chained vs True CPI (1979-2022)"}, f)
...
if "dbpi_cum" in df.columns:
    ...
    fig2.write_image("cpi_medical_v3.png")
    with open("cpi_medical_v3.png.meta.json","w") as f:
        json.dump({"caption": "Medical CPI vs Disease-Based Price Index (1999-2022)"}, f)

print("Charts saved.")
print("\nDone. Output files:")
print("  cpi_adjusted_v3_dbpi_1979_2022.csv")
print("  cpi_headline_v3.png")
print("  cpi_medical_v3.png  (only if DBPI loaded)")
